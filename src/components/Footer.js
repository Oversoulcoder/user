        ...
        <div className="container-xxl">
          <div className="row">
            <div className="col-4">
              ...
              <div>
                <address className="text-white fs-6">
                  7XRM+XCQ, Fuentes Rd, <br /> Pasag, Lapu-Lapu City, <br />{" "}
                  6015 Cebu.
                </address>
                <a
                  href="tel:+639231158063"
                  className="mt-3 d-block mb-1 text-white"
                >
                  +639231158063
                </a>
                <a
                  href="mailto:michaeladlawan@gmail.com"
            ...
            <div className="col-2">
              ...
              <div className="footer-links d-flex flex-column">
                <Link className="text-white py-2 mb-1">Sport Shoes</Link>
                <Link className="text-white py-2 mb-1">Hiking Shoes</Link>
                <Link className="text-white py-2 mb-1">Casual Shoes</Link>
                <Link className="text-white py-2 mb-1">Dress Shoes</Link>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="row">
            <div className="col-12">
              <p className="text-center mb-0 text-white">
                &copy; {new Date().getFullYear()}; Powered by Socx dev{" "}
              </p>
            </div>
          </div>
        </div>
