...
const Home = () => {
  return (
    <>
            ...
            <div className="col-12">
              <div className="service d-flex align-items-center justify-content-between">
                <div className="d-flex align-items-center gap-15">
                  ...
                  <div>
                    <h6>Free Shipping</h6>
                    <p className="mb-0">From all orders over Php50.00</p>
                  </div>
                </div>
                <div className="d-flex align-items-center gap-15">
      ...
      <section className="featured-wrapper py5 home-wrapper-2">
        <div className="container-xxl">
          <div className="row">
            <div className="col-12">
              ...
              <div className="famous-card position-relative">
                ...
                <div className="famous-content position-absolute">
                  ...
                  <p className="text-dark">
                    Now in green. From Php 55,985.46 or Php 2,500/mo. for 24
                    month Footnote*
                  </p>
                </div>
              </div>
      ...
      <section className="blog-wrapper py5 home-wrapper-2">
        <div className="container-xxl">
          <div className="row">
            <div className="col-12">
